...
const CACHE = 'puritan-parser-v105-v1.9.1-hebrew-vocabulary-audit';
const FILES = [
  './',
  './index.html',
  './styles.css',
  './styles.css?v=v1.9.1-hebrew-vocabulary-audit-1',
  './src/main.js',
  './src/main.js?v=v1.9.1-hebrew-vocabulary-audit-1',

...
test('v1.3.1 app shell and service worker keep Reference assets reachable without stale versioning', () => {
  ...
  assert.match(sw, /puritan-parser-v94-v1\.8\.1-unified-learning-practice/, 'service-worker cache version is bumped for the final unified learning and practice pass');
  assert.match(fs.readFileSync('index.html', 'utf8'), /src\/main\.js\?v=v1\.8\.1-unified-learning-practice-verified-5/, 'startup query string is bumped with the cache');

...
- The v1.3.6b noun and suffix registry is checked against Gesenius §§58–59, 89, 91, 93, 95–96, and 103 (printed pp. 155–160, 247, 254–285, and 300–305). It separates state/number, noun suffixes, preposition suffixes, limited verbal-object examples, segolate/reducible-vowel families, and peculiar nouns.
...
- v1.3.6b nominal coverage is representative rather than exhaustive. Segolate ground-form labels and “peculiar noun” groupings follow the source without claiming a complete historical classification or lexical inventory.
...
- Added v1.3.6b tests for stable chart families, person/gender/number structure, exact source metadata, NFC and pointing, honest omissions, filters, RTL/source links, About & Sources disclosure, recognition isolation, and verb/Greek/Handbook/persistence boundaries.

...
(function(root){
  ...
  const greekParticiple = (label, m, f, n) => chart(label, ['Case','Masculine','Feminine','Neuter'], [['Nom sg',m,f,n],['Gen sg',m.replace(/ων$|ος$/,'οντος'),f.replace(/α$|η$/,'ης'),n.replace(/ον$/,'οντος')],['Nom pl',m.replace(/ων$|ος$/,'οντες'),f.replace(/α$|η$/,'αι'),n.replace(/ον$/,'οντα')]]);
  const greekLyoTabs = [
    { id:'present', label:'Present', charts:[
      ...
      greekParticiple('Present Active Participle','λύων','λύουσα','λῦον'), greekParticiple('Present Middle/Passive Participle','λυόμενος','λυομένη','λυόμενον') ]},

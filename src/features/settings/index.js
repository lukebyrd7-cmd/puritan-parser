...
function renderAboutSources(){
  ...
  shell.innerHTML = `<article class="about-sources-page">
    ...
    <section id="lexical-gloss-sources"><h2>Lexical glosses and personal glosses</h2><p>Greek and Hebrew standard glosses are lemma-level learning aids maintained in Puritan Parser’s source-controlled gloss data. They are distinct from the contextual occurrence glosses shown for particular Hebrew tokens. Occurrence glosses can help in one verse, but they do not replace a word’s standard study meaning.</p><p>You may keep the standard glosses, add your own alongside them, or use your own as the study answer. Personal glosses are stored only in this browser unless you export them. Puritan Parser may apply documented, source-backed corrections through a reviewable correction manifest; no correction is inferred from an occurrence translation.</p><p>The technical source, version, license, transformation, and verification ledger is documented in <code>docs/data-source-ledger.md</code>.</p></section>
